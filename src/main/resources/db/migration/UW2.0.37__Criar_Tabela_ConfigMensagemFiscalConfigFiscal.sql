...
create table config_mensagem_fiscal_config_fiscal (
	...
	CONSTRAINT config_mensagem_fiscal_config_fiscal_config_mensagem_fiscal_id_foreign FOREIGN KEY (config_mensagem_fiscal_id) REFERENCES config_mensagem_fiscal (id)
);