...
@Service
public class SinteticoGeralStrategy extends AbstractRelatorioStrategy {
    ...
    @Autowired
    public SinteticoGeralStrategy(ReportsService reportsService, EmpresaService empresaService,
    ...
    protected String getReportName() {
        return "financeiro/SinteticoGeral";
    }
