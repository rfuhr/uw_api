...
@Service
@AllArgsConstructor
public class SelecionaContratoAgricolaParaRomaneioQuery {

	EntityManager em;

	@SuppressWarnings("unchecked")
	public List<ContratoAgricolaSelecaoResponse> executeSQL(Long parceiroId, Long itemId, Long safraId) {
		List<Tuple> resultTuples = em
				.createNativeQuery(SQLUtils.obterQuery("/agricola/selecionaContratoAgricolaParaRomaneio"), Tuple.class)
				.setParameter("parceiroId", parceiroId).setParameter("itemId", itemId).setParameter("safraId", safraId)
				.getResultList();
