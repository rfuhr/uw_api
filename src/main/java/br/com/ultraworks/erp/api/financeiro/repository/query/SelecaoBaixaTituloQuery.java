...
@Service
@AllArgsConstructor
public class SelecaoBaixaTituloQuery {

	EntityManager em;

	@SuppressWarnings("unchecked")
	public List<SelecaoBaixaResponse> executeSQL(Long empresaFilialId, Long tipoTituloId, Long departamentoId,
		...
		List<Tuple> resultTuples = em.createNativeQuery(SQLUtils.obterQuery("selecaoBaixaTitulo"), Tuple.class)
		...
		return resultTuples.stream()
				.map(t -> SelecaoBaixaResponse.builder().baixar(t.get("baixar", Boolean.class))
						.parcial(t.get("parcial", Boolean.class)).valorBaixa(t.get("valorBaixa", BigDecimal.class))
						.valorJuros(t.get("valorJuros", BigDecimal.class))
						.valorDesconto(t.get("valorDesconto", BigDecimal.class))
