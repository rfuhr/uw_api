...
@Service
public class SinteticoAbertoStrategy extends AbstractRelatorioStrategy {
    ...
    @Autowired
    public SinteticoAbertoStrategy(ReportsService reportsService, EmpresaService empresaService,
    ...
    protected String getReportName() {
        return "financeiro/SinteticoAberto";
    }
    ...
    protected String getSql(ISelecaoRelatorioRequest request) {
    	...
    	if (financeiroRequest.getCompetencia().isBefore(LocalDate.now())) {
    		...
    		return SQLUtils.obterQuery("relatorioFinanceiroSinteticoAberto");
    	}
    }
}
