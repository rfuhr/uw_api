...
@Service
public class PosicaoTituloAbertoVencimentoStrategy extends AbstractRelatorioStrategy {
    ...
    @Autowired
    public PosicaoTituloAbertoVencimentoStrategy(ReportsService reportsService, EmpresaService empresaService,
    ...
    protected String getReportName() {
        return "financeiro/PosicaoTituloAbertoVencimento";
    }
