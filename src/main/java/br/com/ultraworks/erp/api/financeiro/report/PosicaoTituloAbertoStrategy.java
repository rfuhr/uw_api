...
@Service
public class PosicaoTituloAbertoStrategy extends AbstractRelatorioStrategy {
    ...
    @Autowired
    public PosicaoTituloAbertoStrategy(ReportsService reportsService, EmpresaService empresaService,
    ...
    protected String getReportName() {
        return "financeiro/PosicaoTituloAberto";
    }
